...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['code'])){
  ...
  $redirectUri = urlencode('http://yeebaplay.com.br/yeeba/u/pages/logar.php');
      ...
      if(isset($user->email) && $user->email){
		    ...
		    */
			...
			if($camposEmail) 
			{
				...
				echo '<script>window.location.assign("http://yeebaplay.com.br/yeeba/u/pages/")</script>';
				echo "Cadastrado com sucesso!";
				exit;
			} else {
				echo "Falha no cadastro, 
					  tente mais tarde pode ser um problema no servidor!";
				echo '<script>window.location.assign("http://yeebaplay.com.br/yeeba/u/pages/?e=_erro")</script>';
				exit;
			}
      }
    }else{
  ...
  echo 'Permiss�o n�o concedida';
	...
	if($camposEmail != 0){
		...
		if($senha != mysql_result($consultaEmail,0,"Senha")) {
			...
			echo '<script>window.location.assign("http://yeebaplay.com.br/yeeba/?e=_errol")</script>';
			exit;
		} else {
