                ...
                <div class="col-lg-8">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                                //MINHAS PERGUNTAS CURTIDAS
                            error_reporting(0);
                                $limite = 30; //Limite de post por página
                                $SQL = mysql_query("SELECT tp.* FROM tb_post tp, tb_curtir_post tcp WHERE tp.id = tcp.col_id_da_postagem AND tcp.col_id_de_quem_curtiu = $ID"); //Contagem dos elementos do banco por id
                                ...
                                $sql = mysql_query ("SELECT tp.* FROM tb_post tp, tb_curtir_post tcp WHERE tp.id = tcp.col_id_da_postagem AND tcp.col_id_de_quem_curtiu = $ID ORDER BY tcp.id DESC LIMIT $start, $limite");
                                ...
                                if ($contador > 0)
                                {
                                    ...
                                    <div class="alert alert-warning">
                                        ...
                                        <center>Você ainda não curtiu nenhuma publicação.</center>
                                    </div>
                                    ';
                                }
                            ?>
