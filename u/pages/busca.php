                ...
                <div class="col-lg-8">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <center>
                            <a href="busca.php?pg=1&b=<?php echo $palavraBuscada; ?>&tipo=arquivo"><div type="button" class="btn btn-outline btn-success">Apostilas</div></a>
                            <a href="busca.php?pg=1&b=<?php echo $palavraBuscada; ?>&tipo=usuario"><div type="button" class="btn btn-outline btn-success">Usuarios</div></a>
                            <a href="busca.php?pg=1&b=<?php echo $palavraBuscada; ?>&tipo=publicacoes"><div type="button" class="btn btn-outline btn-success">Publicações</div></a>
                            </center>
                            <br />
                            <?php 
                            if($tipoBusca == "arquivo")
                            {
                                include"include/BuscaArquivos.php";
                            }
                            else if($tipoBusca == "usuario")
                            {
                                include"include/BuscaUsuarios.php";

                            }else if($tipoBusca == "publicacoes")
                            {
                                include"include/BuscaPublicacoes.php";
                            }
