                ...
                <div class="col-lg-8">
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                $sql = mysql_query ("SELECT * FROM contatos WHERE id_membro = $ID ORDER BY ID DESC");
                                ...
                                if ($contador > 0)
                                {
                                        ...
                                        if($curso == ""){ $curso = "Fórum Geral";}
                                            ...
                                            echo '
                                                    <a href="profile.php?id='.$id_adicionado.'">
                                                        <table class="conteudo-perfil" width="200" border="0">
                                                          <tr>
                                                            <td align="left" width="63"><img src="../../uploads/fotos/'.$foto.'" width="60" height="60" alt="" /></td>
                                                            <td><table width="100%" border="0">
                                                              <tr>
                                                                <td align="left" class="fonte13">
                                                                    <div class="wrap_user">'?> <?php resumir($nome, 15); ?> <?php echo'</div>
                                                              </td>
                                                              </tr>
                                                              <tr>
                                                                <td class="fonte11">'.$curso.'</td>
                                                              </tr>
                                                            </table></td>
                                                          </tr>
                                                        </table>
                                    ...
                                    echo'
                                         <div class="alert alert-warning">
                                            ...
                                            Você ainda não adicionou ninguém, vá no perfil do usuário e clique em "Adicionar Contato"
                                        </div>
                                    ';
                                }
