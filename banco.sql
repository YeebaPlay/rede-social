...
--
-- Host: localhost
-- Generation Time: 29-Nov-2016 às 15:37
...
CREATE TABLE `adicionar_arquivos` (
  ...
  `hora_arquivo` varchar(100) NOT NULL,
...
--
-- Estrutura da tabela `adicionar_aviso_grupo`
--

CREATE TABLE `adicionar_aviso_grupo` (
  `id` int(11) NOT NULL,
  ...
  `id_donodoaviso` int(11) NOT NULL
...
CREATE TABLE `contatos` (
  `id` int(11) NOT NULL,
  `nome_membro` varchar(200) COLLATE utf8_swedish_ci NOT NULL,
  `nome_adicionado` varchar(200) COLLATE utf8_swedish_ci NOT NULL,
  `id_membro` int(11) NOT NULL,
  `id_adicionado` int(11) NOT NULL,
  `foto` varchar(200) COLLATE utf8_swedish_ci NOT NULL,
...
CREATE TABLE `dados_usuarios` (
  ...
  `Senha` char(150) CHARACTER SET latin1 NOT NULL,
  ...
  `DataNasc` varchar(15) CHARACTER SET latin1 NOT NULL,
  ...
  `Pergunta` varchar(200) CHARACTER SET latin1 NOT NULL,
  `Resposta` varchar(200) CHARACTER SET latin1 NOT NULL,
  `Sobre` text NOT NULL,
...
CREATE TABLE `notas_alunos` (
  ...
  `nota` text COLLATE utf8_swedish_ci NOT NULL,
  `titulo` varchar(200) COLLATE utf8_swedish_ci NOT NULL,
  `data` varchar(150) COLLATE utf8_swedish_ci NOT NULL,
  `hora` varchar(11) COLLATE utf8_swedish_ci NOT NULL,
  `importante` varchar(10) COLLATE utf8_swedish_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
...
--
-- Estrutura da tabela `tb_arquivo_categoria`
--

CREATE TABLE `tb_arquivo_categoria` (
  `id` int(11) NOT NULL,
  `col_des_nome` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_arquivo_categoria`
--

INSERT INTO `tb_arquivo_categoria` (`id`, `col_des_nome`) VALUES
(1, 'Arquivos'),
(2, 'Membros'),
(3, 'Turmas');
...
INSERT INTO `tb_curso` (`id`, `col_des_nome`, `col_id_dono`) VALUES
(1, 'Ciência da Computação', 0),
(2, 'Matemática', 0),
(3, 'Arquitetura', 0),
(4, 'Ciências Contábeis', 0),
(5, 'Inglês', 0),
(6, 'Sistema da Informação', 0),
(7, 'Medicina', 0),
(8, 'Jogos Indie', 0),
(9, 'Administração', 0),
(10, 'Todas as Engenharias', 0),
(11, 'Agronomia', 0),
(12, 'Biologia', 0),
(13, 'Odontologia', 0),
(14, 'Arquitetura', 0),
(15, 'Design de interiores', 0),
(16, 'Geral', 0),
(17, 'Mecatrônica', 0),
(18, 'Geografia', 0);
...
--
-- Estrutura da tabela `tb_curtir_arquivo`
--

CREATE TABLE `tb_curtir_arquivo` (
  `id` int(11) NOT NULL,
  `col_id_usuario` int(11) NOT NULL,
  `col_id_apostila` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_curtir_post`
--

CREATE TABLE `tb_curtir_post` (
  `id` int(11) NOT NULL,
  `col_id_da_postagem` int(11) NOT NULL,
  `col_id_de_quem_curtiu` int(11) NOT NULL,
  `col_data` varchar(100) NOT NULL,
  `col_hora` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_denuncias_post`
--

CREATE TABLE `tb_denuncias_post` (
  `id` int(11) NOT NULL,
  `col_id_da_denuncia` int(11) NOT NULL,
  `col_id_do_usuario` int(11) NOT NULL,
  `col_hora` varchar(100) NOT NULL,
  `col_data` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_disciplina` (
  `id` int(11) NOT NULL,
  `col_id_usuario` int(11) NOT NULL,
  `col_des_descricao` text NOT NULL,
  `col_des_referencia` varchar(200) NOT NULL,
  `col_des_disciplina` varchar(255) NOT NULL,
  `col_des_objetivo` varchar(255) NOT NULL,
  `col_des_metodologia` varchar(255) NOT NULL,
  `col_dta_inclusao` date NOT NULL,
  `col_dta_alteracao` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_estado` (`id`, `nome`, `uf`, `pais`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
--
-- Estrutura da tabela `tb_forum_interacoes`
--

CREATE TABLE `tb_forum_interacoes` (
  `id` int(11) NOT NULL,
  `col_id_usuario` int(11) NOT NULL,
  `col_id_curso` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_instituicao` (
  `id` int(11) NOT NULL,
  `col_des_nome` varchar(255) NOT NULL,
  `col_des_sigla` varchar(20) NOT NULL,
...
--
-- Estrutura da tabela `tb_mensagem_nome`
--

CREATE TABLE `tb_mensagem_nome` (
  `id` int(11) NOT NULL,
  `col_nome_destinatario` varchar(200) NOT NULL,
  `col_nome_remetente` varchar(200) NOT NULL,
  `col_email_destino` varchar(255) NOT NULL,
  `col_mensagem` text NOT NULL,
  `col_data` varchar(50) NOT NULL,
  `col_hora` varchar(50) NOT NULL,
  `col_id_remetente` int(11) NOT NULL,
  `col_id_destino` int(11) NOT NULL,
  `col_ultimo_envio` int(11) NOT NULL,
  `col_mensagem_apagada_remetente` int(11) NOT NULL,
  `col_mensagem_apagada_destino` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_mensagem_respostas`
--

CREATE TABLE `tb_mensagem_respostas` (
  `id` int(11) NOT NULL,
  `col_id_mensagem` int(11) NOT NULL,
  `col_nome_remetente` varchar(200) NOT NULL,
  `col_mensagem_resposta` text NOT NULL,
  `col_data` varchar(50) NOT NULL,
  `col_hora` varchar(50) NOT NULL,
  `col_id_remetente` int(11) NOT NULL,
  `col_id_destino` int(11) NOT NULL,
  `col_mensagem_nao_lida` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_post` (
  `col_nome` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `id` int(11) NOT NULL,
  `col_categoria` varchar(255) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_pergunta` text CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_data` datetime NOT NULL,
  `col_hora` varchar(11) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_id_membro` int(11) NOT NULL,
  `col_foto` varchar(200) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_video` varchar(100) NOT NULL,
  `col_imagem` varchar(255) NOT NULL,
...
--
-- Estrutura da tabela `tb_post_turma`
--

CREATE TABLE `tb_post_turma` (
  `id` int(11) NOT NULL,
  `col_des_nome` varchar(255) NOT NULL,
  `col_categoria` varchar(255) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_pergunta` text CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_dta_data` datetime NOT NULL,
  `col_id_membro` int(11) NOT NULL,
  `col_id_turma` int(11) NOT NULL,
  `col_video` varchar(100) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  `col_imagem` varchar(255) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_post_turma_comentario`
--

CREATE TABLE `tb_post_turma_comentario` (
  `id` int(11) NOT NULL,
  `col_des_comentario` text NOT NULL,
  `col_id_membro` int(11) NOT NULL,
  `col_id_pergunta` int(11) NOT NULL,
  `col_id_turma` int(11) NOT NULL,
  `col_dta_data` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_turma` (
  `id` int(11) NOT NULL,
  `col_des_nome_turma` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `col_id_disciplina` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `col_des_descricao` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `col_id_usuario` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `col_num_ano` int(11) NOT NULL,
  `col_id_cidade` int(11) NOT NULL,
  `col_ativo` int(11) NOT NULL,
  `col_dta_inclusao` date NOT NULL,
  `col_dta_alteracao` date NOT NULL,
  `col_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `tb_turma_membro`
--

CREATE TABLE `tb_turma_membro` (
  `col_id_membro` int(11) NOT NULL,
  `col_id_turma` int(11) NOT NULL,
  `col_aprovado` varchar(10) COLLATE utf8_swedish_ci NOT NULL,
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;
...
CREATE TABLE `trabalhos` (
  ...
  `tamanho_arquivo` varchar(50) NOT NULL,
  `tipo_arquivo` varchar(100) NOT NULL,
  `hora` varchar(50) NOT NULL,
  `data` varchar(50) NOT NULL,
  `dia_envio` varchar(50) NOT NULL,
  `mes_envio` varchar(50) NOT NULL,
  `ano_envio` varchar(50) NOT NULL,
  `id_grupo` int(11) NOT NULL,
...
--
-- Estrutura da tabela `trabalhos_a_serem_feitos`
--

CREATE TABLE `trabalhos_a_serem_feitos` (
  `id` int(11) NOT NULL,
  ...
  `mes_entrega` varchar(20) NOT NULL,
  `ano_entrega` varchar(20) NOT NULL,
...
--
-- Indexes for table `adicionar_arquivos`
--
ALTER TABLE `adicionar_arquivos`
  ADD PRIMARY KEY (`id_arquivo`);

--
-- Indexes for table `adicionar_aviso_grupo`
--
ALTER TABLE `adicionar_aviso_grupo`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `notas_alunos`
--
...
--
-- Indexes for table `tb_arquivo_categoria`
--
ALTER TABLE `tb_arquivo_categoria`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_curtir_arquivo`
--
ALTER TABLE `tb_curtir_arquivo`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_curtir_post`
--
ALTER TABLE `tb_curtir_post`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_denuncias_post`
--
ALTER TABLE `tb_denuncias_post`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_forum_interacoes`
--
ALTER TABLE `tb_forum_interacoes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_mensagem_nome`
--
ALTER TABLE `tb_mensagem_nome`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_mensagem_respostas`
--
ALTER TABLE `tb_mensagem_respostas`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_post_turma`
--
ALTER TABLE `tb_post_turma`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_post_turma_comentario`
--
ALTER TABLE `tb_post_turma_comentario`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_turma_membro`
--
ALTER TABLE `tb_turma_membro`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `trabalhos_a_serem_feitos`
--
ALTER TABLE `trabalhos_a_serem_feitos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `adicionar_arquivos`
--
ALTER TABLE `adicionar_arquivos`
  MODIFY `id_arquivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1415;
--
-- AUTO_INCREMENT for table `adicionar_aviso_grupo`
--
ALTER TABLE `adicionar_aviso_grupo`
...
--
ALTER TABLE `country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
-- AUTO_INCREMENT for table `notas_alunos`
--
ALTER TABLE `notas_alunos`
...
--
-- AUTO_INCREMENT for table `tb_arquivo_categoria`
--
ALTER TABLE `tb_arquivo_categoria`
...
--
-- AUTO_INCREMENT for table `tb_curtir_arquivo`
--
ALTER TABLE `tb_curtir_arquivo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `tb_curtir_post`
--
ALTER TABLE `tb_curtir_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=734;
--
-- AUTO_INCREMENT for table `tb_denuncias_post`
--
ALTER TABLE `tb_denuncias_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tb_forum_interacoes`
--
ALTER TABLE `tb_forum_interacoes`
...
ALTER TABLE `tb_instituicao`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_mensagem_nome`
--
ALTER TABLE `tb_mensagem_nome`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
--
-- AUTO_INCREMENT for table `tb_mensagem_respostas`
--
ALTER TABLE `tb_mensagem_respostas`
...
--
-- AUTO_INCREMENT for table `tb_post_turma`
--
ALTER TABLE `tb_post_turma`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `tb_post_turma_comentario`
--
ALTER TABLE `tb_post_turma_comentario`
...
ALTER TABLE `tb_turma`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tb_turma_membro`
--
ALTER TABLE `tb_turma_membro`
...
ALTER TABLE `trabalhos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `trabalhos_a_serem_feitos`
--
ALTER TABLE `trabalhos_a_serem_feitos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
